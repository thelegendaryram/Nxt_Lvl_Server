...
class RecentFilesBrowser(QtWidgets.QDialog):
    def __init__(self):
        ...
        self.setMinimumSize(1700, 450)  # Increased window height to accommodate the footer
        ...
        self.table_widget.setIconSize(QtCore.QSize(64, 64))  # Icon size
    ...
    def populate_recent_files(self):
        ...
        for row, file_path in enumerate(recent_files):
            ...
            item_file.setIcon(self.get_thumbnail_icon(file_path))  # File icon
        ...
        self.table_widget.setColumnWidth(0, 1160)  # Full Path column width
        self.table_widget.setColumnWidth(1, 150)  # Date column width
        self.table_widget.setColumnWidth(2, 150)  # Time column width
        self.table_widget.setColumnWidth(3, 150)  # Nuke Version column width

    def get_thumbnail_icon(self, file_path):
        ...
        if extension == ".nk":
            ...
            return self.style().standardIcon(QtWidgets.QStyle.SP_MediaPlay)
        else:
            return self.style().standardIcon(QtWidgets.QStyle.SP_FileIcon)
    ...
    def get_recent_files(self):
        ...
        if os.path.exists(recent_files_path):
            ...
            print("File not found: {}".format(recent_files_path))
    ...
    def open_selected_comp(self):
        ...
        if selected_row >= 0:
            ...
            if os.path.exists(file_path):
                ...
                QtWidgets.QMessageBox.warning(self, "Error", "File not found: {}".format(file_path))
        else:
    ...
    def delete_selected_file(self):
        ...
        if selected_row >= 0:
            ...
            if os.path.exists(file_path):
                ...
                QtWidgets.QMessageBox.information(self, "Success", "Deleted: {}".format(file_path))
                self.play_sound()  # Play a sound notification
            else:
                QtWidgets.QMessageBox.warning(self, "Error", "File not found: {}".format(file_path))
        else:
    ...
    def copy_file_path(self):
        ...
        if selected_row >= 0:
            ...
            QtWidgets.QMessageBox.information(self, "Success", "Copied: {}".format(file_path))
        else:
            QtWidgets.QMessageBox.warning(self, "Error", "Please select a file!")
